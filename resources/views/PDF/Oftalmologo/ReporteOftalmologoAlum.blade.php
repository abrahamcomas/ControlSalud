...
$DatosCurso =  DB::table('Alumno')->select('Nombre','NombreEscuela','Nombres','Apellidos')
...
?>
    ...
    <center>  
          	<h4>
          		<strng><u>Reporte Oftalmologo Alumno</u></strng>
          	</h4>
            <h4>
    ...
    <table  width="100%" border="1"  > 
        <thead>
            <tr> 
              	<th>
              		<center>Nombre Oftalmologo</center>
              	</th>
              	<th>
              		<center>Fceha</center>
              	</th>
    ...
    <?php 	foreach ($Vacunas as $row): ?>
 			<tr>
            	<td>
            		<center><?php echo $row->Nombre_O; ?></center>
            	</td>
            	<td>
