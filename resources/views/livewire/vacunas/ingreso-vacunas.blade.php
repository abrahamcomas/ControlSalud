<div>
  @if($IngresoDatos==0 AND $M_Detalles==0)
    <div class="row"> 
        ...
        <center>  
          <h4>
            INGRESAR VACUNAS <strong>{{ $AnioActual }}</strong>
          </h4>
    		</center> 
    ...
    <div class="row"> 
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
        ...
        <table table class="table table-hover"> 
          ...
          <tbody>
            @foreach($ListaVacunasIngresadas as $row) 
              <tr>
                @if($row->Aceptada==1)
                    <td>
  ...
  @if($IngresoDatos==2 AND $M_Detalles==2)
    <div class="row"> 
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
        ...
        <center>  
          <h4>
            <strong>EDITAR DATOS {{ $NombresVacunasEditar}}</strong>
          </h4>
        </center>
        <hr> 
        @include('messages')   
