  ...
  @if($IngresoDatos==0 AND $M_Detalles==0)
    <div class="row">  
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
        ...
        <center>  
          <h4>
            INGRESAR OFTALMOLOGOS <strong>{{ $AnioActual }}</strong>
          </h4>
        </center> 
  ...
  @if($M_Detalles==1)
    <div class="row"> 
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
        ...
        <center>  
          <h4>
            <strong>LISTA OFTALMOLOGOS</strong>
          </h4>
        </center>
        <table table class="table table-hover"> 
          <thead>
          ...
          <tbody>
            @foreach($ListaOftalmologosIngresadas as $row) 
              <tr>
                @if($row->Aceptada==1)
                    <td>
        ...
        <div class="form-group">
          <select class="form-control" wire:model="ID_Oftalmologo">
            <option selected><strong>Lista Oftalmologos</strong></option>
        ...
        <div class="form-group">
          ...
          <div class="form-label-group">
            <input type="date" wire:model="FechaVacunacion" class="form-control">
          </div> 
        </div> 
        <div class="form-group">
  ...
  @if($IngresoDatos==2 AND $M_Detalles==2)
    <div class="row"> 
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
        ...
        <center>  
          <h4>
            <strong>EDITAR DATOS {{ $NombresOftalmologoEditar}}</strong>
          </h4>
        </center>
        <hr> 
        @include('messages')   
        <div class="form-group">
         ...
         <div class="form-group"> 
          <center><h6>FECHA</h6></center>
          <div class="form-label-group">
            <input type="date" wire:model="ED_FechaVacunacion" class="form-control">
          </div> 
        </div> 
        <div class="form-group">
          <center><h6>OBSERVACIÓN</h6></center>
