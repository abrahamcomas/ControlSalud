  ...
  @if($IngresoDatos==0 AND $M_Detalles==0)
    <div class="row"> 
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
        ...
        <center>  
          <h4>
            INGRESAR OTORRINO <strong>{{ $AnioActual }}</strong>
          </h4>
        </center> 
    ...
    <div class="row"> 
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
        ...
        <table table class="table table-hover"> 
          ...
          <tbody>
            @foreach($ListaOtorrinoIngresadas as $row) 
              <tr>
                @if($row->Aceptada==1)
                    <td>
        ...
        <div class="form-group">
          ...
          <div class="form-label-group">
            <input type="date" wire:model="FechaOtorrino" class="form-control">
          </div> 
        </div> 
        <div class="form-group">
  ...
  @if($IngresoDatos==2 AND $M_Detalles==2)
    <div class="row"> 
      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
        ...
        <center>  
          <h4>
            <strong>EDITAR DATOS {{ $NombresOtorrinoEditar}}</strong>
          </h4>
        </center>
        <hr> 
        @include('messages')   
        <div class="form-group">
         ...
         <div class="form-group">
          <center><h6>FECHA</h6></center>
          <div class="form-label-group">
            <input type="date" wire:model="ED_FechaOtorrino" class="form-control">
          </div> 
        </div> 
        <div class="form-group">
          <center><h6>OBSERVACIÓN</h6></center>
